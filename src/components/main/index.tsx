      ...
      {path === "/" ? (
        ...
        <S.SearchContentsArea>
          ...
          <NovelSearchBox
            ...
            views={41324}
            content={
              "우나ㅗ어ㅏㅣ으뤄너라느ㅜ러ㅏㅏㅇ라ㅣ느라ㅣ늬ㅏㄹㄴ으ㅏㅣㄹ우ㅏ라ㅣㅈ대러ㅜ파둧거ㅏ룬다ㅓ루아륻ㄹㅈ더ㅐ뢔쟈루ㅏ더ㅜㄹ자ㅓㅜㅏㄴ어란어리ㅏ널댜ㅐ자ㅡ루ㅠ홀다으루ㅗㅓ야ㅏㅡㅜ포ㅓㅑㅐㄴ아뤄"
            }
          />
        </S.SearchContentsArea>
      )}
